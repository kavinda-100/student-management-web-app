...
const ZodRoleEnum = z.enum(["admin", "user", "superadmin"]);
export type ZodRoleType = z.infer<typeof ZodRoleEnum>;
const ZodClassEnum = z.enum([
  "A",
  "B",
  "C",
  "D",
...
const ZodSemesterEnum = z.enum(["1", "2", "3"]);
const ZodAttendanceStatusEnum = z.enum(["present", "absent", "late"]);
...
export type ZodUserDetailsUpdateType = z.infer<typeof ZodUserDetailsUpdateSchema>;
